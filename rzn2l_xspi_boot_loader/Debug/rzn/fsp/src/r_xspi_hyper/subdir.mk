...
C_SRCS += \
../rzn/fsp/src/r_xspi_hyper/r_xspi_hyper.c 

LST += \
r_xspi_hyper.lst 

C_DEPS += \
./rzn/fsp/src/r_xspi_hyper/r_xspi_hyper.d 

OBJS += \
./rzn/fsp/src/r_xspi_hyper/r_xspi_hyper.o 
...
rzn/fsp/src/r_xspi_hyper/%.o: ../rzn/fsp/src/r_xspi_hyper/%.c
	@echo 'Building file: $<'
