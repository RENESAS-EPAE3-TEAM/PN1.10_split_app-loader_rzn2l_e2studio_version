# PN1.10_split_app-loader_rzn2l_e2studio_version
The original fused rzn2l_xspi_boot project was split into two independently built units: Standalone Loader and Standalone app
